        ...
        <div className="list">
          <div className="item">
            ...
            <div className="content">
              ...
              <div className="topic">
                We specialize in creating immersive visitor experiences by
                integrating multimedia technology, interactive elements, and
                architecture. Our comprehensive approach allows us to
                effectively transform brand visions into reality.
              </div>
              <div className="des">
          ...
          <div className="item">
            ...
            <div className="content">
              ...
              <div className="topic">
                Our artistic team, with a strong international background in
                live events and permanent construction, is well-equipped to
                successfully manage exceptional projects of any scope, scale, or
                location.
              </div>
              <div className="des">
                {/* Lorem ipsum dolor, sit amet consectetur adipisicing elit. Ut sequi, rem magnam nesciunt minima placeat, itaque eum neque officiis unde, eaque optio ratione aliquid assumenda facere ab et quasi ducimus aut doloribus non numquam. Explicabo, laboriosam nisi reprehenderit tempora at laborum natus unde. Ut, exercitationem eum aperiam illo illum laudantium? */}
