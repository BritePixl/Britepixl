        ...
        {firstSlide ? (
          <div className="home_container_content slide_down_animation">
            <div>
              ...
              <h2 className="paragraph">
                We create immersive experiences by blending multimedia and
                interactivity to realize brand visions.
              </h2>
            </div>
          </div>
        ) : (
          <div className="home_container_content slide_down_animation">
            <div>
              ...
              <h2 className="paragraph">
                Our global artistic team excels in managing exceptional projects
                of any scope, scale, or location
              </h2>
            </div>
          </div>
        )}
