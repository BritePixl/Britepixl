      ...
      <div className="contact_us_container">
            ...
            <div className="form">
                ...
                <div className="info">
                    ...
                    <br />
                    <br />
                    <span><h2>Regional Office - Azerbaijan</h2>AGA, Business Center, Office 406, 4th Floor, 55 Khojali Avenue, Baku, Azerbaijan <br />+994998809004</span>
                    <br />
                    <br />
                    <span>hello@britepixl.ae</span>
                </div>
                <div className="social-media">
                    <p>Check Our <Link to='/privacy' className='mt'>Privacy Policy</Link></p>
                </div>
                </div>
                ...
                <form>
                    ...
                    <div className="input-container">
                    <input placeholder='Email' value={email} onChange={e => setEmail(e.target.value)} type="email" name="email" className="input" />
                    <span>Email</span>
                    </div>
                    <div className="input-container">
                    <input placeholder='Phone' value={phone} onChange={e => setPhone(e.target.value)} type="tel" name="phone" className="input" />
                    <span>Phone</span>
                    </div>
                    <div className="input-container textarea">
                    <textarea placeholder='Message' value={msg} onChange={e => setMsg(e.target.value)} name="message" className="input"></textarea>
                    <span>Message</span>
                    </div>
                    <input onClick={() => sendMsg()} type="button"  value="Send" className="btn" />
                    <p>{ status }</p>
                </form>
                </div>
            </div>
