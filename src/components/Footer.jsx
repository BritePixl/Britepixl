    ...
    <footer>
      <div className="footer_card">
        ...
        <div className="footer_footer">
          ...
          <div className="">
            <p>
              <Link to="/privacy-policy">Privacy Policy</Link> | BritePixl
            </p>
          </div>
          <div className="to_right">
            <a
              className="social_media_icon"
              href="https://www.instagram.com/britepixl_uae"
              target="_blank">
              <img src={instagram} alt="" />
            </a>
            <a
              className="social_media_icon"
              href="https://linkedin.com/company/britepixl"
              target="_blank">
              <img src={linkedin} alt="" />
            </a>
            <a
              className="social_media_icon"
              href="https://whatsapp.com/channel/0029VagNvRp59Pwa1uM8la3Z"
              target="_blank">
